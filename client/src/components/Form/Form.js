...
const Form = ({ currentId, setCurrentId }) => {
  ...
  return (
    <Paper className= {classes.paper}>
      <form autoComplete="off" noValidate className={`${classes.form} ${classes.root}`} onSubmit={handleFormSubmit}>
        ...
        <Button variant="contained" color="secondary" size="small" type="submit" fullwidth onClick={handleClear}> Clear
        </Button>
      </form>
    </Paper>
  )
